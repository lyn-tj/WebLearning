...
//    }
    ...
    @ApiImplicitParam(name = "user",value = "所添加用户的具体信息",required = true, dataType = "User", paramType="body")
    ...
    @ApiImplicitParam(name = "user",value = "所修改用户的具体信息",required = true, dataType = "User", paramType="body")
